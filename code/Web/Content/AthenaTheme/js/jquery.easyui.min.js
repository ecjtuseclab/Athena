...
var _afdis=$("<div class=\"pagination-info\"></div>").appendTo(_af);
var ps = $("<select class=\"pagination-page-list\"></select>").appendTo(_af);
ps.bind("change", function () {
    _ae.pageSize = parseInt($(this).val());
    _ae.onChangePageSize.call(_ac, _ae.pageSize);
    _b8(_ac, _ae.pageNumber);
...
$.fn.pagination.defaults = {
    ...
    }, displayMsg: "显示第 {from} 到第 {to} 条记录，总共 {total} 条记录", afterPageText: "of {pages}", beforePageText: "Page", nav: {
        first: {
