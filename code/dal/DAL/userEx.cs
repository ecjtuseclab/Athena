   ...
   public class userEx : RepositoryBase<user>, IuserEx
    {
       ...
       /// <returns></returns>
        ...
        public void roleAuthority(string rolelistIds, int keyValue)
        {
            ...
            string rolenameofus= ure.getRoleName(u.id);
            u.rolelist = rolenameofus;
            //this.update(u.id,u.username);
            this.update(u);
        ...
        public void groupAuthority(string grouplistIds, int keyValue)
        {
            ...
            string groupnameofus = uge.getGroupName(u.id);
            u.grouplist = groupnameofus;
            this.update(u);
        }
       /// <summary>
       /// 新增用户并对密码进行加密
