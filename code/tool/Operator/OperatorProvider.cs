namespace Athena.tool.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Athena_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Athena_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Athena_licence", Licence.GetLicence());
        }
